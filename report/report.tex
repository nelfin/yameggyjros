...
Hz. Precisely, the screen interrupt fires every 2,688 cycles (every 84 cycles
with a prescaling of $\frac{1}{32}$) and a total of 48 firings are needed to
completely refresh the screen, given 8 columns with 3 colour luminosity times
2 brightness passes.  This gives a precise refresh rate of:
...
and loading functions. This array is not always consistent with the actual
EEPROM memory however - save and load functions are provided for synchronising
